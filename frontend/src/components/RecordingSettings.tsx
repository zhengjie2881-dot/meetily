        ...
        <div className="space-y-4">
          ...
          <div className="p-4 border rounded-lg bg-blue-50">
            ...
            <div className="text-xs text-blue-600 mt-1">
              录音将按时间保存：recording_YYYYMMDD_HHMMSS.{preferences.file_format}
            </div>
          </div>
        </div>
      )}
