  ...
  useEffect(() => {
    ...
    const loadSummaryLanguage = async () => {
      try {
        ...
        toast.warning('无法加载已保存的总结语言', {
          description: '读取会议信息前将使用自动检测。',
        });
        ...
        try {
          ...
          if (
            ...
            if (saved.storage === 'local_fallback') {
              toast.info('总结语言已保存在此设备上', {
                description: '此会议没有录音文件夹，因此无法写入会议信息。',
              });
            }
            if (request.language) {
    ...
    <Popover open={langPickerOpen} onOpenChange={setLangPickerOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          title={`总结语言：${effectiveLangLabel}${isLocalFallbackLanguage ? '（已保存在此设备上）' : ''}`}
          aria-label="设置总结语言"
        >
          <Languages size={18} />
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center flex-1">
            <div className="text-center">
              ...
              <p className="text-gray-600">正在生成会议纪要...</p>
            </div>
          </div>
        </div>
      ) : !aiSummary ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {summaryResponse && (
            <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-4 max-h-1/3 overflow-y-auto">
              <h3 className="text-lg font-semibold mb-2">会议纪要</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-medium mb-1">重点内容</h4>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">会议决策</h4>
                  <ul className="list-disc pl-4">
              ...
              {summaryResponse.raw_summary ? (
                <div className="mt-4">
                  <h4 className="font-medium mb-1">完整纪要</h4>
